function getUsernameFromLocalStorage() {
  return localStorage.getItem('alex_local');
}
...
function fetchUserCoins(username) {
  ...
  const url = 'https://script.google.com/macros/s/AKfycbxRwRQ58jXYTUfd8PYZWpqg38eFckG727tjsTvscquhiXyp5JVSkewaF7UOHCvN4AlEgw/exec';
