const SCRIPT_URL = "https://script.google.com/macros/s/AKfycbwn_yqYg1atxg7Hvfw54PLMQ3M4r33eswS0fm7Ckc_YpnqIAUJCkJu_HH19OrpQ3FQF-Q/exec";
...
async function submitData() {
    ...
    try {
        ...
        if (result.status === 'success') {
            ...
            localStorage.setItem('alex_local', formData.username);
