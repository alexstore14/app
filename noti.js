const localUsername = localStorage.getItem('alex_local');

async function fetchUserData(username) {
    try {
        const response = await fetch('https://script.google.com/macros/s/AKfycbypSpGOdwwKoAg2tHqisSGlFa-9AwUC7mr7nbmSIUGotgxVpIlNaD-nKyWFVlhbPFNRAA/exec?username=' + username);
